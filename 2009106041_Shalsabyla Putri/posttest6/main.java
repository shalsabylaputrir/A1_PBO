...
public class main {
    ...
    static void lihat_data(){
        ...
        orderan data4 = new orderan("atong", "Baju", 20000);
        orderan data5 = new orderan("upin", "celana", 50000);
        atong data6 = new atong("Atong", "jaket","Pelanggan Tetap", 100000);
        ...
        System.out.println("\n");
        System.out.println("================================");
        System.out.println("\tMenu Orderan " +1  );
        System.out.println("================================");
        data4.orderan1();
        System.out.println("================================");
        System.out.println("\tMenu Orderan " +2  );
        System.out.println("================================");
        data5.orderan2();
        System.out.println("================================");
        System.out.println("\tMenu Orderan" +3  );
        System.out.println("================================");
        data6.orderan3();
